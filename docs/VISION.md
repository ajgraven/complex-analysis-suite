...
> rationale. The plan it motivates has since been executed: five apps now ride eight shared
...
- Adding a *fourth* tool (the argument-principle applet, Arnold tongues, or the Zipper
  ...
  than the third was, because `core`, `gpu`, `expr`, `interchange`, `exact`, `schwarz`, `dynamics`, and
