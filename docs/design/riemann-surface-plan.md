...
| **M1 gate** | ⏳ in progress | full gate (typecheck · lint +dep:check · test · build) + browser goldens; existing tests incl. top-down-3D≡2D unchanged; pushed; **pause for review** |
