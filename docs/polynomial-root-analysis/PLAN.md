...
- **Not the root-cloud picture.** `apps/polynomial-roots` (ADR-0046, merged 2026-09-23 while this
  ...
  *(Corrected 2026-09-26: the premise is false — Polynomial Roots enumerates finite alphabets
  EXHAUSTIVELY and has no random sampling and no Kac / Kostlan / Weyl ensemble at all. So random-
  polynomial ensembles are covered by NEITHER app; the 2026-09-26 review lists them as an unscheduled
  extension of Polynomial Roots, and this plan may still take them back.)*
...
| Engine                                                                                         | Where                                                                 | Runs                                                                           |
| ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Numeric roots, polish, Smith discs, critical points, bounds, κ                                 | `@cas/core` (roots) + this app's own root engine (discs on `@cas/exact`) | main thread, per frame                                                         |
...
limit · _(random-polynomial ensembles: covered by neither app — §1.2's correction)_ ·
