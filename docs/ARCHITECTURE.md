...
> The suite ships **six** packages: `@cas/core`, `@cas/interchange`, `@cas/expr`, `@cas/gpu`, `@cas/exact`,
> `@cas/schwarz` (the last two extracted later than the phase plan, on the ADR-0007 second-consumer rule).
