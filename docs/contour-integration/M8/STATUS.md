...
- **Execution: PHASE 0 IS MERGED, and PHASE 1 HAS BEGUN.**
  ...
  **Next execution action: step 3.1b** (the card's stepper form: Prev / Next / All, step dots,
  arrow keys, `session.step`; open by default at step 1 in Worked-example mode).
