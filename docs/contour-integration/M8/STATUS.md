...
- **Execution: PHASE 0 IS MERGED, and PHASE 1 HAS BEGUN.**
  ...
  **Next execution action: step 1.12** (parity, cutover, deletion — `main.ts` swaps to the new shell
  unconditionally and `src/shell/app.ts` is deleted). The branch may be
