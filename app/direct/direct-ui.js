...
(function () {
  ...
  // Sample the bounded-mode boundary ∂Ω = φ(∂𝔻) from the rational input P/Q,
  // honoring the weight: classical φ = P/Q; power φ = (R#)^{1/α} on the branch
  // anchored at φ(0) (so the plotted domain matches the true one, not a rotated
  // sheet); log φ = w₀·exp(r#).
