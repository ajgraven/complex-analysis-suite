...
/** Render a Gaussian rational as a bare magnitude string (no leading sign) and its sign, for term output. */
function renderGaussMag(g: Gauss): { sign: 1 | -1; mag: string; isUnit: boolean } {
