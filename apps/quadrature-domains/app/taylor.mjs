...
// ESM exports (Phase 2). Native-module port of taylor.js — byte-identical apart from the
// import of Complex and the module boundary. Feeds @cas/core (formal series) in Phase 3.
export { Taylor };
