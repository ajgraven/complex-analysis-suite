...
// ESM (Phase 2 port) — twin of ui-pole-grid.js (classic stays frozen). QD_UI factory module.
...
(function (global) {
  ...
  QD_UI.installPoleGrid = function installPoleGrid(ui) {
