...
const PAGES = [
  ...
  {
    // PRA-7: a family opened, by permalink — x⁵ − x − t in the t-plane, its flower of lassos and the
    // bridge. `expect` keys on the flower's list, which only an open family (`fm: [..., 1]`) renders.
    id: "polynomial-root-analysis-family",
    mount: "polynomial-root-analysis",
    dist: "apps/polynomial-root-analysis/dist",
    file: "index.html",
